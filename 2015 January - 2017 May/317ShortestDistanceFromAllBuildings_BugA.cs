...
namespace _317ShortestDistanceFromAllBuildings
{
    /*
     * Leetcode 317:
    ...
    class Solution
    {
        ...
        public int shortestDistance(int[][] grid) {
            ...
            {                      
                ...
                BFS(node, 0, ref dist, ref reach, grid, ref visited, ref queue);                                    
            }
         ...
         * 
         * bug 001 - C# ref need for those jagged arrays (? add, bug is there. and then, remove ref )
         ...
         */
        public void fill(
            int origX, int origY, int x, int y, int curDistance, ref int[][] dist, ref int[][] reach, 
            int[][] grid, ref bool[][] visited, ref Queue<Node> queue)
        {
            int m = grid.Length;
            int n = grid[0].Length;
