    ...
    class Program
    {
        ...
        public static string LongestWord(string[] words) {
            ...
            foreach(var word in words)
            {
                if(word.Length == 1)
                {
                    runDepthFirstSearch(unorderedSet, word, ref search); 
                }
            }
        ...
        private static void runDepthFirstSearch(HashSet<string> set, string word, ref string search)
        {
            var length = word.Length;
            var maxLength = search.Length;
            ...
            for(char c = 'a'; c <= 'z'; c++)
            {
                ...
                {
                    runDepthFirstSearch(set, nextWord, ref search); 
                }
            }
        }      
    }
